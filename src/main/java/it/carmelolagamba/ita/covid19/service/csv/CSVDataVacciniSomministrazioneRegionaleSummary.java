    ...
    protected void map(DataVacciniSomministrazioneRegionaleSummary vacciniSomministrazioneRegionaleSummary, int i,
        ...
        switch (fields[i]) {
            ...
            case PREGRESSA_INFEZIONE:
                vacciniSomministrazioneRegionaleSummary.setPregressa_infezione(FileUtils.convertStringToInteger(value));
                break;
            case DOSE_AGGIUNTIVA:
                vacciniSomministrazioneRegionaleSummary.setDose_aggiuntiva(FileUtils.convertStringToInteger(value));
                break;
            case DOSE_BOOSTER:
