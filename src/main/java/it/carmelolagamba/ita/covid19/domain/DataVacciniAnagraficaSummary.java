...
public class DataVacciniAnagraficaSummary {
    ...
    private int totale, sesso_maschile, sesso_femminile, categoria_operatori_sanitari_sociosanitari,
            ...
            categoria_forze_armate, categoria_personale_scolastico, prima_dose, seconda_dose, pregressa_infezione, dose_aggiuntiva, dose_booster;
    private Date ultimo_aggiornamento;
    private Date ultimo_aggiornamento_interno;

    public enum FIELD {
        FASCIA_ANAGRAFICA, TOTALE, SESSO_MASCHILE, SESSO_FEMMINILE, PRIMA_DOSE, SECONDA_DOSE, PREGRESSA_INFEZIONE, DOSE_AGGIUNTIVA, DOSE_BOOSTER, ULTIMO_AGGIORNAMENTO 
    }
