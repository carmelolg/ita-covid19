...
public class DataVacciniSomministrazioneRegionaleSummary {
	...
	public enum FIELD {
		DATA_SOMMINISTRAZIONE, FORNITORE, AREA, FASCIA_ANAGRAFICA, SESSO_MASCHILE, SESSO_FEMMINILE, PRIMA_DOSE, SECONDA_DOSE, PREGRESSA_INFEZIONE, DOSE_AGGIUNTIVA, DOSE_BOOSTER, CODICE_NUTS1, CODICE_NUTS2, CODICE_REGIONE_ISTAT,
		NOME_AREA 
	}
